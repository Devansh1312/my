...
class TournamentGames(models.Model):
    ...
    group_id = models.ForeignKey(GroupTable, on_delete=models.CASCADE, blank=True, null=True)
    team_a = models.ForeignKey(TeamBranch,related_name="team_a_tournament",on_delete=models.CASCADE, blank=True, null=True)
    team_a_goal = models.IntegerField(blank=True, null=True)
    team_b =models.ForeignKey(TeamBranch,related_name="team_b_tournament",on_delete=models.CASCADE, blank=True, null=True)
    ...
    team_a_third_color_player = models.CharField(max_length=255,null=True,blank=True)
    ...
    team_a_third_color_goalkeeper = models.CharField(max_length=255,null=True,blank=True)
    ...
    team_b_third_color_player = models.CharField(max_length=255,null=True,blank=True)
    ...
    team_b_third_color_goalkeeper = models.CharField(max_length=255,null=True,blank=True)
